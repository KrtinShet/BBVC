import { Box, Container, Typography, Grid, TextField, Button, Card, CardContent, TableContainer, Table, TableRow, TableCell } from "@mui/material";
...
const VerifyCertificate: React.FC<{}> = () => {
  ...
  const handleEnter = () => {
    if (!isAddressEqual((applicantData as any)[0], AddressZero)) {
          ...
          <Grid container spacing={2} mt={4}>
            <Grid item xs={12} sm={6} sx={{
              ...
              <Upload
                ...
                file={file}
                onDelete={() => { setFile(null); setCid("") }}
                onDrop={handleDropSingleFile}
              />

            </Grid>
            <Grid item xs={12} sm={6}>
              {(cid && isCertficateValid) && (<Card sx={{ minWidth: 275 }}>
                <CardContent>
                  <TableContainer>
                    <Table>
                      <TableRow>
